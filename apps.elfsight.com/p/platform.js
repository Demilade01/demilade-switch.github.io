      ...
      , v = function(e, t, n) {
        ...
        w.resetWidget = function(e) {
            ...
            w.getWidgetsElements().forEach(function(n) {
                w.getWidgetIdByElement(n) === e && (delete m[e],
        ...
        w.initWidget = function(e) {
            ...
            if (i) {
                if (!i.status || !i.data)
                    return void w.logError('Widget "' + t + '" can`t be initialized because ' + i.reason, e);
                i.data.id = t,
                i.data.platform = !0,
