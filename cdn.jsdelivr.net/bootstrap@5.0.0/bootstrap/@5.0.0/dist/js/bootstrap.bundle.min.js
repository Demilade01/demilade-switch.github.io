...
!function(t, e) {
    ...
    class H extends M {
        ...
        _removeElement(t) {
            ...
            const e = s(t);
            I.one(t, "transitionend", ()=>this._destroyElement(t)),
            a(t, e)
        }
        _destroyElement(t) {
    ...
    I.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', H.handleDismiss(new H)),
    m("alert", H);
    class R extends M {
        static get DATA_KEY() {
            return "bs.button"
    ...
    class X extends M {
        ...
        pause(t) {
            t || (this._isPaused = !0),
            U.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (o(this._element),
            this.cycle(!0)),
        ...
        _handleSwipe() {
            ...
            this.touchDeltaX = 0,
            e && this._slide(e > 0 ? V : q)
        }
        _addEventListeners() {
            this._config.keyboard && I.on(this._element, "keydown.bs.carousel", t=>this._keydown(t)),
            "hover" === this._config.pause && (I.on(this._element, "mouseenter.bs.carousel", t=>this.pause(t)),
        ...
        _addTouchEventListeners() {
            ...
            this._pointerEvent ? (I.on(this._element, "pointerdown.bs.carousel", e=>t(e)),
            I.on(this._element, "pointerup.bs.carousel", t=>i(t)),
            this._element.classList.add("pointer-event")) : (I.on(this._element, "touchstart.bs.carousel", e=>t(e)),
        ...
        _keydown(t) {
            ...
            this._slide(V)) : "ArrowRight" === t.key && (t.preventDefault(),
            this._slide(q)))
        }
        _getItemIndex(t) {
    ...
    class Z extends M {
        ...
        show() {
            ...
            if (t) {
                ...
                if (e = n ? v.get(n, "bs.collapse") : null,
        ...
        fn: function(t) {
            ...
            Object.keys(e.elements).forEach((function(t) {
                var i = e.styles[t] || {}
                  , n = e.attributes[t] || {}
                  , s = e.elements[t];
                dt(s) && at(s) && (Object.assign(s.style, i),
        ...
        effect: function(t) {
            ...
            function() {
                Object.keys(e.elements).forEach((function(t) {
                    ...
                    dt(n) && at(n) && (Object.assign(n.style, o),
    ...
    function Et(t) {
        ...
        return i && ("html" === at(i) || "body" === at(i) && "static" === _t(i).position) ? e : i || function(t) {
            ...
            if (-1 !== navigator.userAgent.indexOf("Trident") && dt(t) && "fixed" === _t(t).position)
                return null;
    ...
    var Ct = {
        ...
        phase: "main",
        fn: function(t) {
            var e, i = t.state, n = t.name, s = t.options, o = i.elements.arrow, r = i.modifiersData.popperOffsets, a = ft(i.placement), l = Tt(a), c = [it, et].indexOf(a) >= 0 ? "height" : "width";
            if (o && r) {
                var d = function(t, e) {
    ...
    function Nt(t) {
        ...
        }(o) : "function" == typeof c ? c(o) : o, h = d.x, u = void 0 === h ? 0 : h, f = d.y, p = void 0 === f ? 0 : f, g = o.hasOwnProperty("x"), m = o.hasOwnProperty("y"), _ = it, b = J, v = window;
        if (l) {
            var y = Et(i)
              , w = "clientHeight"
              , E = "clientWidth";
            y === lt(i) && "static" !== _t(y = vt(i)).position && (w = "scrollHeight",
            E = "scrollWidth"),
            y = y,
            s === J && (b = tt,
            p -= y[w] - n.height,
    ...
    function Kt(t, e) {
        return "viewport" === e ? Ft(function(t) {
            ...
            var e, i = vt(t), n = Wt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = At(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = At(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + zt(t), l = -n.scrollTop;
    ...
    function qt(t) {
        var e, i = t.reference, n = t.element, s = t.placement, o = s ? ft(s) : null, r = s ? Yt(s) : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
        switch (o) {
        case J:
            e = {
                x: a,
    ...
    function ne(t, e, i) {
        void 0 === i && (i = !1);
        var n, s, o = vt(e), r = pt(t), a = dt(e), l = {
            scrollLeft: 0,
            scrollTop: 0
        }, c = {
            x: 0,
    ...
    class ye extends M {
        ...
        _completeHide(t) {
            I.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach(t=>I.off(t, "mouseover", u)),
            this._popper && this._popper.destroy(),
            ...
            for (let i = 0, n = e.length; i < n; i++) {
                ...
                if (t) {
                    ...
                    if (e.includes(n._element) || "inside" === n._config.autoClose && !i || "outside" === n._config.autoClose && i)
                        continue;
                    if ("keyup" === t.type && "Tab" === t.key && n._menu.contains(t.target))
                        continue;
    ...
    const we = ()=>{
      ...
      , Oe = (t,e)=>{
        U.find(t).forEach(t=>{
            ...
            void 0 === i ? t.style.removeProperty(e) : (z.removeDataAttribute(t, e),
            t.style[e] = i)
        }
        )
    }
    ...
    class xe {
        ...
        dispose() {
            this._isAppended && (I.off(this._element, "mousedown.bs.backdrop"),
    ...
    class Ne extends M {
        ...
        _showElement(t) {
            ...
            if (e) {
                ...
                I.one(this._dialog, "transitionend", n),
                a(this._dialog, t)
            } else
                n()
        }
        ...
        _triggerBackdropTransition() {
            ...
            I.one(this._element, "transitionend", ()=>{
                ...
                t || (I.one(this._element, "transitionend", ()=>{
    ...
    class qe extends M {
        ...
        show() {
            ...
            if (this.tip.classList.contains("fade")) {
                const t = s(this.tip);
                I.one(this.tip, "transitionend", p),
                a(this.tip, t)
            } else
                p()
        }
        ...
        setElementContent(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = We(e, this.config.allowList, this.config.sanitizeFn)),
        ...
        _initializeOnDelegatedTarget(t, e) {
            ...
            return (e = e || v.get(t.delegateTarget, i)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach(t=>{
                if ("click" === t)
                    I.on(this._element, this.constructor.Event.CLICK, this.config.selector, t=>this.toggle(t));
                else if ("manual" !== t) {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new qe(this,i)),
                "string" == typeof t)) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class ei extends M {
        ...
        _activate(t) {
            ...
            const e = this._selector.split(",").map(e=>`${e}[data-bs-target="${t}"],${e}[href="${t}"]`)
              , i = U.findOne(e.join(","));
            i.classList.contains("dropdown-item") ? (U.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"),
    ...
    class oi extends M {
        ...
        show() {
            ...
            this._config.animation) {
                const e = s(this._element);
                I.one(this._element, "transitionend", t),
                a(this._element, e)
            } else
                t()
        }
